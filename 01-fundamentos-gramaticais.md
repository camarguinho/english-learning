# Parte I — Fundamentos Gramaticais
...
| Inglês | Português |
|---|---|
| I fixed a bug in production yesterday. | Corrigi um bug em produção ontem. |
...
| Inglês | Português |
|---|---|
| Creating a new class has a lower cost than changing the algorithm. | Criar uma classe custa menos do que mudar o algoritmo. |
...
| Inglês | Português |
|---|---|
| I need to go to the hotel. | Eu preciso ir ao hotel. |
| We need to fix this bug today. | Precisamos corrigir esse bug hoje. |
...
| one person → many people | uma pessoa → muitas pessoas |
...
| Inglês | Português |
|---|---|
| I have two questions. | Tenho duas perguntas. |
| We fixed three bugs today. | Corrigimos três bugs hoje. |
...
| What time is checkout? | Que horas é o checkout? |
...
| Inglês | Português |
|---|---|
| My family consists of me, my wife, and our kids. | Minha família é formada por mim, minha esposa e nossos filhos. |
...
| Inglês | Português |
|---|---|
| Each test has a single responsibility. | Cada teste tem uma única responsabilidade. |
| Each member of the team reviews the code. | Cada membro do time revisa o código. |
...
| Inglês | Português |
|---|---|
| Noun: a quick response. / Verb: I responded quickly. | Substantivo: resposta rápida. / Verbo: respondi rápido. |
...
| Inglês | Português |
|---|---|
| This is a good idea. (adjetivo — descreve "idea") | Essa é uma boa ideia. |
| My boss reacted very well. (advérbio — descreve "reacted") | Meu chefe reagiu muito bem. |
...
| Inglês | Português |
|---|---|
| I'll follow up by email. | Vou dar retorno por e-mail. |
| This will probably take two days. | Isso deve levar dois dias. |
...
| Inglês | Português |
|---|---|
| We're going to release the update next week. | Vamos lançar a atualização semana que vem. |
| I'm going to practice drums with my son tonight. | Vou praticar bateria com meu filho hoje. |
...
| Inglês | Português |
|---|---|
| I found the bug yesterday. | Encontrei o bug ontem. (passado) |
| I've already fixed it. | Já corrigi. (presente perfeito) |
| I'm testing the fix right now. | Estou testando agora. (presente contínuo) |
| I'm going to deploy it tomorrow morning. | Vou lançar amanhã. (futuro) |
